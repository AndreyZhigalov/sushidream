        ...
        <svg width="40" height="40" viewBox="0 0 130 130" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_1_26)">
                <g filter="url(#filter0_dddd_1_26)">
                    <path d="M105 63.6364C105 79.7576 105 112 65 112C25 112 25 79.7576 25 63.6364M105 63.6364V65.9394M105 63.6364V36H25V64.2121M45 36C45 30 49 18 65 18C81 18 85 30 85 36" stroke="white" stroke-width="7" stroke-linecap="round" shape-rendering="crispEdges" />
                </g>
            </g>
            <defs>
                <filter id="filter0_dddd_1_26" x="5" y="-2" width="120" height="134" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
...
export const UserIcon = () => {
    return (
        < svg width="35" height="35" viewBox="0 0 100 100" fill="none" >
            <path d="M11 97C11 81.3333 11 50 50 50C89 50 89 81.3333 89 97" stroke="white" stroke-width="7" stroke-linecap="round" />
            <path d="M70 22.5C70 33.2265 61.0893 42 50 42C38.9107 42 30 33.2265 30 22.5C30 11.7735 38.9107 3 50 3C61.0893 3 70 11.7735 70 22.5Z" stroke="white" stroke-width="7" />
        </svg >
    )
}
